import { $ as v8_0_0, B as Color, F as BigPool, H as Texture, N as InstructionSet, P as multiplyHexColors, Q as deprecation, V as Bounds, at as Matrix, dt as ExtensionType, et as v8_3_4, ft as extensions, j as DOMAdapter, nt as uid, ot as Point, q as definedProps, rt as Rectangle, ut as eventemitter3_default, z as warn } from "./Geometry-9wnSDHOD.js";
import { r as ImageSource } from "./canvasUtils-DTnx7QO7.js";
import { t as getTextureBatchBindGroup } from "./getTextureBatchBindGroup-BjGTL2yy.js";
import { n as DefaultBatcher, t as GCManagedHash } from "./GCManagedHash-DoX2WtYi.js";
...
var K = 16;
var blockBBox = /* @__PURE__ */ new Float64Array(0);
var numBlocks = 0;
/** @type {Node[]} */
var blockHead = [];
/** @type {Node[]} */
...
/** @type {Node[]} */
var sortBuf = [];
var zArr = /* @__PURE__ */ new Uint32Array(0);
var zBuf = /* @__PURE__ */ new Uint32Array(0);
var counts = /* @__PURE__ */ new Uint32Array(256);
...
var Polygon = class Polygon {
	...
	*/
	strokeContains(x, y, strokeWidth, alignment = .5) {
		const { points } = this;
		const outerWidth = strokeWidth * (alignment === .5 ? alignment : (alignment - .5) * getOrientationOfPoints(points) + .5);
		...
		for (let i = 0; i < iterationLength; i += 2) {
			...
			if (squaredDistanceToLineSegment(x, y, x1, y1, x2, y2) <= (Math.sign((x2 - x1) * (y - y1) - (y2 - y1) * (x - x1)) < 0 ? outerWidthSquared : innerWidthSquared)) return true;
		}
		return false;
	}
	/**
...
function generateTextureMatrix(out, style, shape, matrix) {
	...
	if (style.textureSpace === "local") {
		...
		textureMatrix.prepend(tempUvMatrix.set(uvs.x1 - uvs.x0, uvs.y1 - uvs.y0, uvs.x3 - uvs.x0, uvs.y3 - uvs.y0, uvs.x0, uvs.y0));
	} else {
	...
	transform(matrix) {
		...
		for (let i = 0; i < this.instructions.length; i++) {
			...
			switch (instruction.action) {
				...
				default: warn("unknown transform action", instruction.action);
			}
		}
		this._dirty = true;
		return this;
	...
	getLastPoint(out) {
		...
		switch (lastInstruction.action) {
			...
			case "arcToSvg":
				...
				break;
			case "addPath": lastInstruction.data[0].getLastPoint(out);
		}
		return out;
	}
};
		...
		for (let j = 0; j < definition.children.length; j++) {
			...
			switch (child.nodeName.toLowerCase()) {
				case "lineargradient":
					...
					break;
				case "radialgradient": session.defs[child.id] = parseRadialGradient(child);
			}
		}
	}
}
...
function renderChildren(svg, session, fillStyle, strokeStyle) {
	...
	switch (svg.nodeName.toLowerCase()) {
		...
		case "g":
		case "svg": break;
		default: warn(`[SVG parser] <${svg.nodeName}> elements unsupported`);
	}
...
//#endregion
export { Circle as $, shapeBuilders as A, curveEps as B, buildArc as C, GraphicsContextRenderData as D, GpuGraphicsContext as E, buildPolygon as F, transformVertices as G, buildEllipse as H, triangulateWithHoles as I, RoundedRectangle as J, buildSimpleUvs as K, buildPixelLine as L, FillGradient as M, buildTriangle as N, GraphicsContextSystem as O, buildRectangle as P, Ellipse as Q, buildLine as R, buildArcTo as S, buildAdaptiveBezier as T, buildRoundedRectangle as U, buildCircle as V, BatchableGraphics as W, squaredDistanceToLineSegment as X, Polygon as Y, getOrientationOfPoints as Z, GraphicsPath as _, FillPattern as a, roundedShapeQuadraticCurve as b, calculatePathArea as c, getFillInstructionData as d, parseSVGPath as et, parseSVGStyle as f, parseSVGFloatAttribute as g, parseSVGDefinitions as h, toStrokeStyle as i, generateTextureMatrix as j, buildContextBatches as k, extractSubpaths as l, extractSvgUrlId as m, getMaxMiterRatio as n, SVGParser as o, styleAttributes as p, buildUvs as q, toFillStyle as r, appendSVGPath as s, GraphicsContext as t, earcut as tt, checkForNestedPattern as u, ShapePath as v, buildAdaptiveQuadratic as w, buildArcToSvg as x, roundedShapeArc as y, closePointEps as z };
